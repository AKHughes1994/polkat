...
if which_ms != 'POLANG':
    ...
    for i in range(0,len(targets)):
        ...
        # --- Correct targets with K, Gp, B, Ga, Df and split
...
#            calwt=False,
            parang=True,
            gainfield = [related_pcal, related_pcal, bpcal_name, bpcal_name, bpcal_name],
...
if which_ms != 'LEAKAGE':
    ...
    gaincal(vis = myms,
        ...
        combine = '',
        gaintable=[ktab,gptab,bptab,gatab,dftab],
        gainfield=[pacal_name,pacal_name,bpcal_name,bpcal_name,bpcal_name],
    ...
    polcal(vis = myms,
        ...
        gainfield=[pacal_name,pacal_name,bpcal_name,bpcal_name,bpcal_name,pacal_name],
        interp = ['nearest','nearest','linear','linear','linear','linear'],
        append = False)
    ...
    #        calwt = False,
            parang = True,
            gaintable = [ktab,gptab,bptab,gatab, dftab, kcross, xftab],
            gainfield = [pacal_name,pacal_name, bpcal_name, bpcal_name, bpcal_name, pacal_name, pacal_name],
            interp = ['nearest','nearest','linear','linear', 'linear','nearest', 'nearest'])
    ...
    for i in range(0,len(pcals)):
        ...
        # --- Correct secondaries with K, Gp, B, Ga, Df, Kcross, Xf
...
#            calwt = False,
            parang = True,
            gaintable = [ktab,gptab,bptab,gatab, dftab, kcross, xftab],
            gainfield = [pcal,pcal, bpcal_name, bpcal_name, bpcal_name, pacal_name, pacal_name],
            interp = ['nearest','nearest','linear','linear', 'linear','linear', 'linear'])
...
#            calwt=False,
            parang=True,
            gaintable = [ktab,gptab,bptab,gatab, dftab, kcross, xftab],
            gainfield = [related_pcal,related_pcal, bpcal_name, bpcal_name, bpcal_name, pacal_name, pacal_name],
            interp = ['nearest','nearest','linear','linear', 'linear','nearest', 'nearest'])
