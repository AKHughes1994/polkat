...
ASTROPY_PATTERN = 'polkat-0.0.1'
CASA_PATTERN = 'polkat-0.0.1'
CLUSTERCAT_PATTERN = 'polkat-0.0.1'
CUBICAL_PATTERN = 'polkat-0.0.1'
DDFACET_PATTERN = 'polkat-0.0.1'
KILLMS_PATTERN = 'polkat-0.0.1'
OWLCAT_PATTERN = 'polkat-0.0.1'
PYBDSF_PATTERN = 'polkat-0.0.1'
RAGAVI_PATTERN = 'polkat-0.0.1'
SHADEMS_PATTERN = 'polkat-0.0.1'
TRICOLOUR_PATTERN = 'oxkat-0.41'
WSCLEAN_PATTERN = 'polkat-0.0.1'
...
CAL_1GC_WHICH_MODE = 'BOTH'          # choose if you want the leakage only ms file ("LEAKAGE"), full pol ms file ("POLANG"), or both of them ("BOTH" -- DEFAULT)
IMAGE_PCAL = True
