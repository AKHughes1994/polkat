...
def fit_cube(image_I, region, output=False):
    ...
    EVPA       = 0.5 * np.arctan2(flux_U, flux_Q) * 180.0 / np.pi
    ...
    return [freq,flux_I,flux_Q,flux_U,flux_V, flux_P, rms_I, rms_Q, rms_U, rms_V, rms_P]
...
def main():
    ...
    np.savetxt('{}_{}.txt'.format(prefix, time_isot), data)
