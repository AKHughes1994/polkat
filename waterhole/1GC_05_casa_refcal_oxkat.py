...
#    calwt=False,
    ...
    interp = ['nearest','nearest','nearest'], flagbackup=False)
...
flagdata(vis=bptab1,mode='tfcrop',datacolumn='CPARAM', flagbackup=False)
flagdata(vis=bptab1,mode='rflag',datacolumn='CPARAM', flagbackup=False)
...
#        calwt = False,
        ...
        interp = ['nearest','linear','linear','linear'], flagbackup=False)
    ...
    flagdata(vis = myms,
        field = pcal,
        mode = 'rflag',
        datacolumn = 'residual', flagbackup=False )
