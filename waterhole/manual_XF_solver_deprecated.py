...
# K has solutions for pacal appended (solved in 1GC_05 working table pass), so gainfield
# for ktab is pacal_name and interp is linear throughout, matching the 1GC_05 XF solve.
applycal(vis = myms,
        field = pacal_name,
        parang = True,
